...
scarcitybanner.Text = 'Thank you for choosing skidcat! join https://discord.gg/rSKuUS5ae'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/skidbetter/peepartywoo67/'..readfile('catrewrite/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
